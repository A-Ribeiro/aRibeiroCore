...
namespace collision {
    ...
    /*
   Quando se aplica os valores: x,y e z � equacao de um plano,
     pode-se obter um numero positivo, negativo ou zero.
   Quando � zero, significa que o ponto (x,y,z) est� dentro do plano
   Quando � negativo ou positivo, o n�mero � a dist�ncia que este ponto
     est� do plano em rela��o a sua normal, que em seu sentido positivo,
