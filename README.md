...
```bash
git clone --recurse-submodules https://github.com/A-Ribeiro/aRibeiroCore.git
```

__SSH__

```bash
git clone --recurse-submodules git@github.com:A-Ribeiro/aRibeiroCore.git
```
...
```bash
git clone https://github.com/A-Ribeiro/aRibeiroCore.git
cd OpenGLStarter
git submodule init
...
```bash
git clone git@github.com:A-Ribeiro/aRibeiroCore.git
cd OpenGLStarter
git submodule init
git submodule update
```
